...
typedef struct {
	int    VA_CONT;
	double VA_ABS[ESPECTRO_ARRAY_SIZE];
	double VA_ANG[ESPECTRO_ARRAY_SIZE];

	int    IA_CONT;
	double IA_ABS[ESPECTRO_ARRAY_SIZE];
	double IA_ANG[ESPECTRO_ARRAY_SIZE];

	int    VB_CONT;
	double VB_ABS[ESPECTRO_ARRAY_SIZE];
	double VB_ANG[ESPECTRO_ARRAY_SIZE];

	int    IB_CONT;
	double IB_ABS[ESPECTRO_ARRAY_SIZE];
	double IB_ANG[ESPECTRO_ARRAY_SIZE];

	int    VC_CONT;
	double VC_ABS[ESPECTRO_ARRAY_SIZE];
	double VC_ANG[ESPECTRO_ARRAY_SIZE];

	int    IC_CONT;
	double IC_ABS[ESPECTRO_ARRAY_SIZE];
	double IC_ANG[ESPECTRO_ARRAY_SIZE];

	int    IN_CONT;
	double IN_ABS[ESPECTRO_ARRAY_SIZE];
	double IN_ANG[ESPECTRO_ARRAY_SIZE];
}espectro_t;
